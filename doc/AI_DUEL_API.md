...
>
> 💡 **真人阅读建议**：本文是**逐接口参考文档**、字段较密。想先建立整体概念，请先看仓库 [`README.md`](../README.md) 与 [`AGENT_QUICKSTART.md`](AGENT_QUICKSTART.md)（快速上手 / 完整请求流）；对局行为「看似诡异」（道具报错、比分跳跃、时序拒绝等）时优先翻 [`AI_DUEL_FAQ.md`](AI_DUEL_FAQ.md)。
>
